...
public class GroupAdapter extends RecyclerView.Adapter<GroupAdapter.GroupViewHolder> implements Filterable {
    ...
    @Override
    public com.legs.unijet.tabletversion.GroupAdapter.GroupViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.courses_sample, viewGroup, false);
        com.legs.unijet.tabletversion.GroupAdapter.GroupViewHolder cvh = new com.legs.unijet.tabletversion.GroupAdapter.GroupViewHolder (v);
        return cvh;
    }

    @Override
    public void onBindViewHolder(@NonNull final com.legs.unijet.tabletversion.GroupAdapter.GroupViewHolder groupViewHolder, int i) {
